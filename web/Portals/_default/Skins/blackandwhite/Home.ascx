...
<div class="contentHolder">
    ...
    <!-- Begin Page Content -->
    <div class="content">
     <div class="hero_slider" id="hero_slider" runat="server"></div>
    <div id="hero_wrapper">
    <div id="left_link_container">
    <a href="#" class="left_link"><img alt="" src="http://localdev.blackandwhitereporting.com/portals/_default/skins/blackandwhite/images/home/heronav_left.png" class="svgimg" /></a></div>
     
          <div id="right_link_container">
      <a href="#" class="right_link"><img alt="" class="svgimg" src="http://localdev.blackandwhitereporting.com/portals/_default/skins/blackandwhite/images/home/heronav_right.png" /></a></div>
      </div>
      <div class="sub_hero_container">
        <div class="sub_hero" id="sub_hero" runat="server"></div>
        </div>
        <div class="white_break_container">
        <div class="white_break" id="white_break" runat="server"></div>
        </div>
        ...
        <div id="cta_container"><div runat="server" id="cta_section" class="cta_section">
...
<script runat="server">
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Page.ClientScript.RegisterClientScriptInclude("home", ResolveUrl("~/portals/_default/skins/blackandwhite/scripts/home.js"))
    End Sub
</script>
