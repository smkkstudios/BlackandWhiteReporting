...
<asp:ListItem Value="WY" Text="Wyoming"></asp:ListItem>
      ...
      <tr><td colspan="2"><h2>I'm not sure yet, but:</h2>
    
  <asp:RadioButtonList ID="radioOptions" CssClass="radioOptions" runat="server">
  <asp:ListItem Value="I'm starting a new business">I'm starting a new business</asp:ListItem>
   <asp:ListItem Value="I'm entering a contract with a new client">I'm entering a contract with a new client</asp:ListItem>
     <asp:ListItem Value="I'm hiring my first employee(s)">I'm hiring my first employee(s)</asp:ListItem>
       <asp:ListItem Value="I have intellectual property I want to protect">I have intellectual property I want to protect</asp:ListItem>
    <asp:ListItem Value="I'm adding owners or investors to my business">I'm adding owners or investors to my business</asp:ListItem>
       <asp:ListItem Value="I'm adding products or services">I'm adding products or services</asp:ListItem>
