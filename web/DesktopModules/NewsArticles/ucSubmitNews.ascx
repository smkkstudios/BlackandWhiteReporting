...
<script type="text/javascript" src='<%= ResolveUrl("Includes/Uploader/swfupload.00.07.61.js") %>'></script>
<script type="text/javascript" src='<%= ResolveUrl("Includes/Uploader/handlers.00.07.61.js") %>'></script>
