...
<asp:ListItem Value="WY" Text="Wyoming"></asp:ListItem>
      ...
      <tr><td colspan="2"><h2>I need someone to train my group to:</h2>
    
  <asp:RadioButtonList ID="radioOptions" CssClass="radioOptions" runat="server">
  <asp:ListItem Value="Effectively administer New York Workers' Compensation claims">Effectively administer New York Workers' Compensation claims</asp:ListItem>
   <asp:ListItem Value="Resolve the inevitable conflicts that will arise">Resolve the inevitable conflicts that will arise</asp:ListItem>
     <asp:ListItem Value="Better recognize client needs">Better recognize client needs</asp:ListItem>
       <asp:ListItem Value="Think like entrepreneurs and leaders">Think like entrepreneurs and leaders</asp:ListItem>
        <asp:ListItem Value="Other">Other (Describe)</asp:ListItem>
