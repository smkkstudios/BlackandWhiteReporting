...
#Region "Event Handlers"
    	...
    	If Not IsPostBack Then
                ...
                Month.DataSource = Enumerable.Range(1, 12).[Select](Function(a) New With { _
                 Key .MonthName = DateTimeFormatInfo.CurrentInfo.GetMonthName(a), _
                 Key .MonthNumber = a _
                })
                Month.DataBind()
                Days.DataSource = Enumerable.Range(1, DateTime.DaysInMonth(DateTime.Now.Year, Convert.ToInt32(Month.SelectedValue)))
                Days.DataBind()
            End If
        End Sub
        Protected Sub Month_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
            Days.DataSource = Enumerable.Range(1, DateTime.DaysInMonth(DateTime.Now.Year, Convert.ToInt32(Month.SelectedValue)))
            Days.DataBind()
        End Sub
